# Azure Sphere V2 Public Staging Test

> Staging Repo used to test aspects of community engagement for the Azure Sphere V2 Project
...
must not cause confusion or imply Microsoft sponsorship. Any use of third-party
